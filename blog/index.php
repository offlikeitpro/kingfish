...
$APPLICATION->SetPageProperty("description", "Обзоры товаров от интернет-магазина Kingfish.by: Блог с полезной информацией");
//$APPLICATION->SetPageProperty("title", "Обзоры товаров: Полезная информация | Kingfish");
...
<?$APPLICATION->IncludeComponent(
	...
	array(
		...
		"IBLOCK_LINK_SERVICES_ID" => "21",
		"IBLOCK_LINK_TIZERS_ID" => "9",
		"IBLOCK_LINK_REVIEWS_ID" => "18",
		"IBLOCK_LINK_STAFF_ID" => "15",
		"IBLOCK_LINK_VACANCY_ID" => "2",
		"IBLOCK_LINK_BLOG_ID" => "16",
		"IBLOCK_LINK_PROJECTS_ID" => "14",
