...
$APPLICATION->SetPageProperty("description", "Интернет-магазин Kingfish.by: Акции");
$APPLICATION->SetPageProperty("title", "Акции Интернет-магазина Kingfish.by");
