...
if ($section) {
    ...
    $arElementFilter['PROPERTY_BRAND'] = $arParams['ID_BRAND'];
    unset($arElementFilter['SECTION_ID']);
    $GLOBALS[$arParams['FILTER_NAME']]['PROPERTY_BRAND'] = $arParams['ID_BRAND'];
