...
<head>
	...
	<title><?$APPLICATION->ShowTitle(); echo pagenTitle();?></title>
...
<?
/**
 * ссылки для noindex, nofollow записываются в /home/host0309/public_html/include/SEO/SEOExceptions.txt
 * на этих страницах будет выводиться мета-тег
 * canonical и meta-noindex,nofollow выводятся функцией EchoCanonicalRobots(); (объявлена в ["DOCUMENT_ROOT"]/include/functions.php)
 */
/*if (stristr($_SERVER['SCRIPT_URL'], '/bitrix/spread.php')){
    ?>
    <meta name="robots" content="noindex, nofollow"/>
    <?
}
if (stristr($_SERVER['SCRIPT_URL'], '/bitrix/urlrewrite.php')){ ?>
    <meta name="robots" content="noindex, nofollow"/>
    <?
}
$page = $APPLICATION->GetCurPage();
if (stristr($page, '/personal/') || stristr($page, '/basket/')) {
    ?><meta name="robots" content="noindex, nofollow"/><?
}*/
/*OLD Canonical
