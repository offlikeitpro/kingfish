                    ...
                    <div class="col-md-3 col-sm-12 contact-block">
                        <div class="info">
                            <div class="row">
                                ...
                                <div class="col-md-12 col-sm-12">
                                    <?= CMax::showAddress2('address blocks footer-address') ?>
                                </div>
                                <div class="col-md-12 col-sm-12">
                                    <?= CMax::showAddress('address blocks footer-address') ?>
                                </div>
                                <div class="col-md-12 col-sm-12">
                                    <div class="social-block">
                                        <? $APPLICATION->IncludeComponent("aspro:social.info.max", ".default", array(
                                            "CACHE_TYPE" => "A",
                                            "CACHE_TIME" => "3600000",
                                            "CACHE_GROUPS" => "N",
                    ...
                    <div class="copy-block col-md-6 col-sm-6 pull-left">
                        <div class="copy font_xs pull-left">
                                <div class="address blocks footer-address">
                                    <? $APPLICATION->IncludeFile(SITE_DIR . "include/footer/copy/shop_description.php", array(), array(
                                            "MODE" => "php",
